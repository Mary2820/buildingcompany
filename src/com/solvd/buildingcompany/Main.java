...
public class Main {
    public static void main(String[] args) {
        ...
        Architect architect = new Architect("Michael", "Thompson", 5, true,
                true);
        ...
        Employee[] projectTeam = {architect, constructionEngineer,
                builder, installer, plumber, electrician, gasTechnician};

        company.assignTeamToProject(projectTeam);
        ...
        constructionEngineer.assignEmployeesTasks(projectTeam, building);
